...
rend.background = Texture("models/back.bmp")
rend.glClearBackground()

# Estrella de Mar - Estatica de escala de grises
rend.active_texture = Texture("models/Starfish.bmp")
rend.normal_map = Texture("models/Starfish_normal.bmp")
rend.active_shader = staticBnW
rend.glLoadModel("models/Starfish.obj",
...
rend.active_texture = Texture("models/MandarinFish.bmp")
rend.normal_map = Texture("models/MandarinFish_normal.bmp")
rend.active_shader = hsv
rend.glLoadModel("models/MandarinFish.obj",
...
rend.active_texture = Texture("models/SurgeonFish.bmp")
rend.normal_map = Texture("models/SurgeonFish_normal.bmp")
rend.active_shader = oompaLoompa
rend.glLoadModel("models/SurgeonFish.obj",
                 translate = V3(1, 0, -17),
                 scale = V3(4.5, 4.5, 4.5),
                 rotate = V3(0,35,0))

# Caballito de mar - HSV
rend.active_texture = Texture("models/Seahorse.bmp")
rend.normal_map = Texture("models/Seahorse_normal.bmp")
rend.active_shader = hsv
rend.glLoadModel("models/Seahorse.obj",
...
rend.active_texture = Texture("models/scallop.bmp")
rend.normal_map = Texture("models/scallop_normal.bmp")
rend.active_shader = normalMap
rend.glLoadModel("models/scallop.obj",
