...
def normalMap(render, **kwargs):
    ...
    if render.normal_map:
        ...
        texNormal = [texNormal[0] * 2 - 1,
                     texNormal[1] * 2 - 1,
                     texNormal[2] * 2 - 1]
        texNormal = normV(texNormal)
        texNormal = [[texNormal[0]], [texNormal[1]], [texNormal[2]]]
        ...
        texNormal =  mm(tangentMatrix, texNormal)
        texNormal = specialNormV(texNormal)

        negDirLight = [-render.dirLight.x, -render.dirLight.y, -render.dirLight.z]
        intensity = dotProduct(texNormal, negDirLight)
    else:
        intensity = dotProduct(triangleNormal, negDirLight)
